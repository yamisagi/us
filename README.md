<div align="center">
  ...
  <h3 align="center">Us App</h3>

  <p align="center">
    This app for my beloved wife and our first wedding anniversary. ".
...
* Used basic widgets like [Text] etc.
* Used collections like List, Map, Set etc.
* Used classes like DateTime, Duration in 3rd party packages.
* Created and worked with custom classes models and views.
* Used 3rd party libraries like [intl](https://pub.dev/packages/intl) for internationalization and [flip_card](https://pub.dev/packages/flip_card) etc.
* Et cetera.

Of course this is not a complete list of features, but I am feeling 'Happy' that i can make a nearly basic app with my knowledge.
And in our wedding anniversary, she were so proud of me. That was the reason I created this app.
And I hope that this app can be useful for you.
...
- [x] Used the [Flutter SDK](https://flutter.dev/docs/get-started/install) to create a new project.
- [x] Used basic Flutter layout
- [x] Used passing data between seperated widgets
- [x] Used creating objects with classes
- [x] Used how to control objects with methods
- [x] Used how to control assets and fonts with [pubspec.yaml]
- [ ] Improve the expenses app with more features
- [x] Improved the expenses app with more UI
- [x] Improved the expenses app with more animations
- [ ] Create database for the expenses app
- [ ] Thinking about feature that can add images with add button
